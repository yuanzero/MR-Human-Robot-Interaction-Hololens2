...
namespace RosSharp.RosBridgeClient.MessageTypes.Moveit
{
    public class AttachedCollisionObject : Message
    {
        ...
        public CollisionObject object_c { get; set; }
        ...
        {
            this.link_name = "";
            this.object_c = new CollisionObject();
            this.touch_links = new string[0];
            this.detach_posture = new JointTrajectory();
            this.weight = 0.0;
        }

        public AttachedCollisionObject(string link_name, CollisionObject object_c, string[] touch_links, JointTrajectory detach_posture, double weight)
        {
